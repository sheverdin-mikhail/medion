    ...
    <div class="medicin">
        <div class="container">
            <div class="medicin__content">
                                ...
                                <div class="swiper-wrapper works__wrapper">
                                    <div class="swiper-slide works_slide ">
                                        <div class="works__item _before">
                                            <img src="static/img/estetic_med/woman.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _in">
                                            <img src="static/img/estetic_med/in-work.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _after">
                                            <img src="static/img/estetic_med/after-work.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                        ...
                        <div class="medicin__works works">
                            <div class="works__row swiper-container">
                                ...
                                <div class="swiper-wrapper works__wrapper">
                                    <div class="swiper-slide works_slide ">
                                        <div class="works__item _before">
                                            <img src="static/img/estetic_med/Rectangle 80.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _in">
                                            <img src="static/img/estetic_med/Rectangle 81.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _after">
                                            <img src="static/img/estetic_med/Rectangle 82.jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                ...
                <div class="medicin__card">
                    <div class="medicin__card_block">
                        <img src="static/img/estetic_med/Rectangle 84(1).jpg" alt="" class="medicin__img">
                        <div class="medicin__buttons">
                            <a id="popup" href="#popup-modal"  class="popup-link medicin__button">
                                <span>Записаться на прием</span>
                            </a>
                        ...
                        <div class="medicin__works works">
                            <div class="works__row swiper-container">
                                ...
                                <div class="swiper-wrapper works__wrapper">
                                    <div class="swiper-slide works_slide ">
                                        <div class="works__item _before">
                                            <img src="static/img/estetic_med/Rectangle 80(1).jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _in">
                                            <img src="static/img/estetic_med/Rectangle 81(1).jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                                    <div class="swiper-slide  ">
                                        <div class="works__item _after">
                                            <img src="static/img/estetic_med/Rectangle 82(1).jpg" alt="" class="works__image ">
                                        </div>
                                    </div>
                ...
                <div class="medicin__card">
                    <div class="medicin__card_block">
                        <img src="static/img/estetic_med/Rectangle 84(2).jpg" alt="" class="medicin__img">
                        <div class="medicin__buttons">
                            <a id="popup" href="#popup-modal"  class="popup-link medicin__button">
                                <span>Записаться на прием</span>
                            </a>
               ...
               <div class="medicin__card">
                    ...
                    <div class="medicin__card_block">
                        <h3 class="medicin__title">Удаление гемматом</h3>
                        <p class="medicin__text">Таким образом новая модель организационной деятельности в значительной степени обуславливает создание позиций, занимаемых участниками в отношении поставленных задач. Значимость этих проблем настолько очевидна, что новая модель организационной деятельности влечет за собой процесс внедрения и модернизации форм развития. </p>
                        <div class="medicin__works works">
                            <div class="works__row swiper-container">
                                <div class="works__header">
