    ...
    <div class="news-view">
        <div class="container">
            <div class="news-view__content">
                ...
                <div class="news-view__block">
                    <p class="news-view__text date">Опубликованно: <?= date("d.m.Y",strtotime($new_get['news_date'])) ?></p>
                    <p class="news-view__text"><?= $new_get['news_description'] ?></p>
                    <p class="news-view__text address"><b>Акция проходит в медицинсом центре по адрес: <?= $new_get['news_address'] ?></b></p>
                    <p class="news-view__text subtext">* Акция действует только в указанном медицинском центре. Скидка распространяется только
на лабораторные услуги, за исключением услуг, указанных в положении о предоставлении скидок.</p>

                    <p class="news-view__text rules"><b>Правила проведения Акций</b></p>
                    <p class="news-view__text "><?= $new_get['news_rules'] ?></p>
                </div>
            </div>
        </div>
    </div>
