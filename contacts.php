    ...
    <? require_once 'templates/about_navigation.php' ?>
        <div class="container">
            ...
            <ul class="search__navigation">
                ...
                <li class="search__navigation_item">Контакты</li>
            </ul>
                        ...
                        <div class="clinic__card">
                            ...
                            <div class="clinic__info">
                                ...
                                <div class="clinic__buttons clinics__buttons">
                                    ...
                                    <a href="<?=$clinic['map']?>" data-clinic="<?= $clinic['id_clinics'] ?>" class="map_view clinic__button clinics__button "><span class="_icon-pin">Показать на карте</span></a>
