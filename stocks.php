            ...
            <div class="news__content">
                ...
                <div class="news__row">
                    <? if (!empty($news)) : ?>
                        <? foreach ($news as $new) : ?>
                            <? if ($new['news_cat'] == 2) : ?>
                                <div class="news__card news__card_stocks" data-link='<?= $new['id_news'] ?>'>
                                    ...
                                    <div class="news__block news__block-content">
                                        ...
                                        <p class="news__text"><? if (strlen($new['news_short']) < 200) : ?><?= $new['news_short'] ?><? else :
                                                                                                                                    ...
                                                                                                                                    ?></p>
                                        <a href="/stocks_detail.php?id=<?= $new['id_news'] ?>" class="news__more"><span>Подробнее </span></a>
                                    </div>
                                </div>
                            <? endif; ?>
                        <? endforeach; ?>
                    <? else : ?>
                        Акций не найдено <br>
                        <a class="news__button " href="/stocks.php">Сбросить результаты поиска</a>
                    <? endif; ?>
                </div>
            </div>
        </div>
